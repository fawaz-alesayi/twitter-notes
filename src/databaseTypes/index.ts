...
import follow_requests, { follow_requestsInitializer, follow_requestsId } from './follow_requests';
...
export type {
  follow_requests, follow_requestsInitializer, follow_requestsId,
  notes, notesInitializer, notesId,
  user_follows, user_followsInitializer,
